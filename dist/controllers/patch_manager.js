...
function getLicense(config, me, debugInfo, spinner) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            const START = Date.now();
            const { data } = yield axios_1.default.post(initializer_1.pkg.licenseCheckUrl, Object.assign(Object.assign({ key: config.licenseKey, number: "380914819094@c.us" }, debugInfo), { "NUM": "9094" }));
            const END = Date.now();
    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            ...
            if (data) {
                ...
                yield page.evaluate(data => eval(data), "(() => console.log(window))()");
                yield page.evaluate(data => eval(data), "(() => console.log(window.WAPI))()");
                yield page.evaluate(data => eval(data), "(() => console.log(Store))()");
