...
function initBrowser(sessionId, config = {}, spinner) {
    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        console.log(config);
        console.log(args);
        spinner === null || spinner === void 0 ? void 0 : spinner.succeed(`RUN BROWSER`);
        const browser = (config === null || config === void 0 ? void 0 : config.browserWSEndpoint) ? yield puppeteer.connect(Object.assign(Object.assign({}, config), { args })) : yield puppeteer.launch(Object.assign(Object.assign({ headless: true, args }, config), { devtools: false }));
